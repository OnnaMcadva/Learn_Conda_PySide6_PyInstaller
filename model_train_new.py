...
class YOLOTrainWindow(QMainWindow):
    def __init__(self):
        ...
        # 1. Dataset folder
        self._add_folder_selector(layout, "Dataset", "Choose dataset folder", folder=True)

        # 2. OUT folder
        self._add_folder_selector(layout, "OUTFolder", "Choose output folder", folder=True)
    ...
    def _add_folder_selector(self, parent_layout, label_text, button_text, folder=False):
        hl = QHBoxLayout()
